...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#05010d] text-white">
      ...
      {/* Hero */}
      <section className="relative flex min-h-[calc(100vh-110px)] items-center justify-center px-6 py-6 sm:px-10">
              ...
              <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.06] p-8 shadow-[0_45px_140px_-60px_rgba(124,58,237,0.85)] backdrop-blur-xl">
                ...
                <div className="mt-6 space-y-4">
                  <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-[#0f0a1f]/80 p-5 shadow-[0_24px_60px_-40px_rgba(79,70,229,0.6)]">
                    ...
                    <p className="text-sm font-semibold text-white">Trigger: Form Submission</p>
                    <p className="pt-1 text-xs text-white/60">Form: Contact Form · Type: Custom</p>
                  </div>
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-white/10 bg-[#070118] px-6 py-8 sm:px-10">
        <div className="mx-auto flex w-full max-w-6xl items-center justify-center">
          <p className="text-sm text-white/40">© {copyrightYear} AutomateWorkflow. All rights reserved.</p>
        </div>
      </footer>
    </main>
  );
